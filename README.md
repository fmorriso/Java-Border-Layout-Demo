...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/java-border-layout-demo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/java-border-layout-demo/-/settings/integrations)
